...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Marin")

# Your User ID.
OWNER_ID = list(map(int, getenv("OWNER_ID", "6924654187").split()))  # Input type must be interger
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/KojiRobot/Marin-Music",
)
